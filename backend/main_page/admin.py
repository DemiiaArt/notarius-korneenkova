...
class HeaderAdmin(admin.ModelAdmin):
    list_display = [
        ...
        'working_hours_ua', 'instagram_url', 'facebook_url', 'twitter_url', 'tiktok_url', 'whatsapp_phone', 'telegram_phone'
    ]
    list_filter = ['email']
    search_fields = [
        'email', 'phone_number', 'phone_number_2',
        ...
        'instagram_url', 'facebook_url', 'twitter_url', 'tiktok_url', 'whatsapp_phone', 'telegram_phone'
    ]
    save_on_top = True
    list_per_page = 25
    ...
    fieldsets = (
        ...
        ('Социальные сети', {
            ...
            'description': 'Заполняйте номера для WhatsApp/Telegram; ссылки формируются на фронте'
        }),
    )
