...
const ExecutiveInscription = () => {
  return <TemplatePage title={"Виконавчий напис на договорі"} content={content} heroImgClass={"notaryServicesPage"} />;
};

export default ExecutiveInscription;