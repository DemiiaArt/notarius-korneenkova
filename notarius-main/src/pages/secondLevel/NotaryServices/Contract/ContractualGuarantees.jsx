...
const ContractualGuarantees = () => {
    return <TemplatePage title={"Договірні гарантії"} content={content} heroImgClass={"notaryServicesPage"} />;
  };
  
  export default ContractualGuarantees;