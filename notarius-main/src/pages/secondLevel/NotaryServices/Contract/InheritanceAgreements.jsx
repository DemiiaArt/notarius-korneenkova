...
const InheritanceAgreements = () => {
    return <TemplatePage title={"Спадкові договори та заповіти"} content={content} heroImgClass={"notaryServicesPage"} />;
  };
  
  export default InheritanceAgreements;