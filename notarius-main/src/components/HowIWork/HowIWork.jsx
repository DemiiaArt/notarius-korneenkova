    ...
    <div className="how-i-work">
      <div className="how-i-work-bg">
        <div className="container">
          <h2
            className={`how-i-work-title uppercase fw-bold ${isPC ? "fs-p--32px" : "fs-p--20px"} c1`}
          >
            Як я працюю
          </h2>
          <div className="how-i-work-block bg4">
            <article className="how-i-work-block-item">
              <p
                className={`how-i-work-block-item-number fs-italic fw-bold ${isPC ? "fs-p--40px" : "fs-p--20px"} c8 lh-100`}
              >
                01
              </p>
              <p
                className={`how-i-work-block-item-text fw-light ${isPC ? "fs-p--18px lh-150" : "fs-p--14px lh-100"}  c8`}
              >
