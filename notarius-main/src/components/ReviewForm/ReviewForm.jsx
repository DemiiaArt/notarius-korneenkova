...
export const ReviewForm = () => {
  ...
  const StarIcon = ({ active = false }) => (
    ...
    >
      <path
        d="M24.2529 13.8965L24.3086 14.0693H38.252L27.1182 22.1582L26.9717 22.2656L27.0273 22.4375L31.2793 35.5254L20.1465 27.4375L20 27.3301L19.8535 27.4375L8.71973 35.5254L12.9727 22.4375L13.0283 22.2656L12.8818 22.1582L1.74805 14.0693H15.6914L15.7471 13.8965L20 0.806641L24.2529 13.8965Z"
        stroke="#8D8D8D"
        strokeWidth="0.5"
      />
    </svg>
    ...
    <div className="container">
      <div className="review-block">
        ...
        <div className="rating-summary">
          <h2 className={`${isPC? "fs-p--28px" : "fs-p--18px"} fw-semi-bold`}>Рейтинг</h2>
          <div className="rate-wrap">
            <div className="rate-score-wrap">
              ...
              <div className={`votes ${isPC ? "fs-p--18px" : "fs-p--10px"} lh-150 c3`}>
            ...
            {[5, 4, 3, 2, 1].map((rating) => {
              ...
              return (
                <div className="bar" key={rating}>
                  <span className={`${isPC ? "fs-p--18px" : "fs-p--10px"}`}>{rating}</span>
        ...
        <div className="review-form">
          <h2 className={`${isPC? "fs-p--28px" : "fs-p--18px"} fw-semi-bold`}>Залишіть свій відгук</h2>

          {/* Звезды */}
          <div className="rate-wrap">
            <label className={`${isPC ? "fs-p--18px" : "fs-p--10px"}`}>Поставте свій рейтинг:</label>
          ...
          >
            ...
            {/* Имя */}
            <div className={`input-group ${isPC ? "fs-p--18px" : "fs-p--10px"} c3 lh-150`}>
              <input
                type="text"
                id="review-name"
                name="name"
            ...
            {/* Кастомный select */}
            <div className={`input-group select-group ${isPC ? "fs-p--18px" : "fs-p--10px"} c3 lh-150`}>
              <div
                className={`c14 custom-select ${isOpen ? "open" : ""}`}
                onClick={() => !isSubmitted && setIsOpen(!isOpen)}
              >
                <div
                  className={`c3 custom-select__trigger ${
            ...
            <button
              ...
              className={`btn-submit ${
                isSubmitted ? isPC ? "fs-p--18px" : "fs-p--10px" : isPC ? "fs-p--24px" : "fs-p--14px"
