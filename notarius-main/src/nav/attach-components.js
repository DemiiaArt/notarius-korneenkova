...
const NotaryTranslatePage = lazy(() => import("@pages/NotaryTranslatePage/NotaryTranslatePage"));
const MilitaryPage = lazy(() => import("@pages/MilitaryPage/MilitaryPage"));
const OtherServicesPage = lazy(() => import("@pages/OtherServicesPage/OtherServicesPage"));
...
const ContractPage = lazy(() => import("@pagesSecondLevel/NotaryServices/ContractPage"));
const SignaturePage = lazy(() => import("@pagesSecondLevel/NotaryServices/SignaturePage"));
const ConsultationPage = lazy(() => import("@pagesSecondLevel/NotaryServices/ConsultationPage"));
const ApostillePage = lazy(() => import("@pagesSecondLevel/NotaryServices/ApostillePage"));
const PropertyAgreements = lazy(() => import("@pagesSecondLevel/NotaryServices/Contract/PropertyAgreements"));
const FamilyAgreements = lazy(() => import("@pagesSecondLevel/NotaryServices/Contract/FamilyAgreements"));
const ContractualGuarantees = lazy(() => import("@pagesSecondLevel/NotaryServices/Contract/ContractualGuarantees"));
const InheritanceAgreements = lazy(() => import("@pagesSecondLevel/NotaryServices/Contract/InheritanceAgreements"));
const CorporateRightsAgreements = lazy(() => import("@pagesSecondLevel/NotaryServices/Contract/CorporateRightsAgreements"));
const ExecutiveInscription = lazy(() => import("@pagesSecondLevel/NotaryServices/Contract/ExecutiveInscription"));
const OtherAgreements = lazy(() => import("@pagesSecondLevel/NotaryServices/Contract/OtherAgreements"));

const AttorneyPage = lazy(() => import("@pagesSecondLevel/NotaryServices/AttorneyPage"));
const PoaProperty = lazy(() => import("@pagesSecondLevel/NotaryServices/Attorney/PoaProperty"));
const PoaRepresentation = lazy(() => import("@pagesSecondLevel/NotaryServices/Attorney/PoaRepresentation"));
const PoaSpecial = lazy(() => import("@pagesSecondLevel/NotaryServices/Attorney/PoaSpecial"));

const Signature = lazy(() => import("@pagesSecondLevel/NotaryServices/Signature/Signature"));
const Applications = lazy(() => import("@pagesSecondLevel/NotaryServices/Signature/Applications"));

const Consultations = lazy(() => import("@pagesSecondLevel/NotaryServices/Consultation/Consultations"));
const DocumentCopies = lazy(() => import("@pagesSecondLevel/NotaryServices/Consultation/DocumentCopies"));

const ApostilleDocs = lazy(() => import("@pagesSecondLevel/NotaryServices/Apostille/ApostilleDocs"));
const Affidavit = lazy(() => import("@pagesSecondLevel/NotaryServices/Apostille/Affidavit"));
